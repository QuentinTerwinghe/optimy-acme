        ...
        <div class="mb-8">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="mt-2 text-sm text-gray-700">Fill in the details below to create a new role with permissions.</p>
                </div>
            ...
            <form @submit.prevent="handleSubmit" class="p-6 space-y-6">
                ...
                <div class="border-b border-gray-200 pb-6">
                    ...
                    <div>
                        ...
                        />
                        <p class="mt-1 text-xs text-gray-500">Use lowercase with underscores (e.g., content_editor)</p>
                    </div>
                </div>
