...
class CampaignValidatedMailTest extends TestCase
{
    use RefreshDatabase;
    ...
    public function test_mailable_builds_successfully(): void
    {
        ...
        $mailable = new CampaignValidatedMail(
            receiver: $receiver,
        ...
        $this->assertEquals('Your Campaign was validated: Test Campaign', $envelope->subject);

        // Test content
        $content = $mailable->content();
        $this->assertEquals('emails.campaign.validated', $content->markdown);
    }
    ...
    public function test_mailable_contains_campaign_data(): void
    {
        ...
        $this->assertEquals('Important Campaign', $mailable->campaign['title']);
        $this->assertEquals('This is very important', $mailable->campaign['description']);
    ...
    public function test_mailable_has_correct_subject_with_campaign_title(): void
    {
        ...
        $this->assertEquals('Your Campaign was validated: My Awesome Campaign', $envelope->subject);
    }
