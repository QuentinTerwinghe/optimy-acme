...
/**
 * Handler for campaign rejected notifications.
 * Sends emails to campaign managers when a campaign status changes to rejected.
 */
class CampaignRejectedHandler extends AbstractNotificationHandler
{
    /**
    ...
    {
        return NotificationType::CAMPAIGN_REJECTED;
    }
     ...
     *                                         - campaign: Campaign (required) - The campaign rejected
     * @return bool
     */
